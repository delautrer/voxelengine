...
public enum Biome {
    ...
    PLAINS(                          "grass_block", "dirt",        "sand",   "stone",       64.0f, 10.0f, 0.3f, 0.0f,  0.7f,  Map.of("grass", 200, "poppy", 5, "dandelion", 5), Map.of("dirt", 0.08f, "gravel", 0.04f),    0.1f,      Map.of("dirt", 0.6f, "sand", 0.4f)),

    FLOWER_PLAINS(                   "grass_block", "dirt",        "sand",   "stone",       64.0f, 12.0f, 0.0f, -0.2f, 0.9f,  Map.of("poppy", 20, "dandelion", 20, "red_tulip", 20, "purple_tulip", 20, "mavvinilia", 20), Map.of("dirt", 0.08f, "gravel", 0.04f), 0.1f, Map.of("dirt", 0.6f, "sand", 0.4f)),

    FOREST(                          "grass_block", "dirt",        "grass_block", "stone",  66.0f, 15.0f, 6.0f, 0.1f,  0.8f,  Map.of("grass", 300, "dotty", 10, "mavvinilia", 10, "fairy_bell", 10), Map.of("dirt", 0.1f, "gravel", 0.03f), 0.12f, Map.of("dirt", 0.8f, "gravel", 0.2f)),
    ...
    HILLS(                           "grass_block", "dirt",        "sand",   "stone",       80.0f, 40.0f, 0.5f, 0.2f,  0.4f,  Map.of("grass", 100, "dandelion", 2),            Map.of("dirt", 0.05f, "gravel", 0.05f),    0.1f,      Map.of("dirt", 0.5f, "gravel", 0.5f)),
