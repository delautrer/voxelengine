...
public class BlockItem extends Item {
    ...
    @Override
    public void onUseRightClick(World world, LocalPlayer localPlayer, Vector3i targetBlock, Vector3i adjacentBlock, PlayerInteraction interaction) {
        ...
        if (!AABB.isColliding(localPlayer.getAABB(), blockBB)) {
