...
public class VulkanRenderPass {
    ...
    private void createRenderPass() {
        try (org.lwjgl.system.MemoryStack stack = org.lwjgl.system.MemoryStack.stackPush()) {
            org.lwjgl.vulkan.VkAttachmentDescription.Buffer attachments = org.lwjgl.vulkan.VkAttachmentDescription
                    .calloc(2, stack);
            ...
            org.lwjgl.vulkan.VkAttachmentReference.Buffer colorAttachmentRef = org.lwjgl.vulkan.VkAttachmentReference
                    .calloc(1, stack);
            colorAttachmentRef.attachment(0);
            colorAttachmentRef.layout(org.lwjgl.vulkan.VK10.VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);

            org.lwjgl.vulkan.VkAttachmentReference depthAttachmentRef = org.lwjgl.vulkan.VkAttachmentReference
                    .calloc(stack);
            depthAttachmentRef.attachment(1);
            depthAttachmentRef.layout(org.lwjgl.vulkan.VK10.VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL);

            org.lwjgl.vulkan.VkSubpassDescription.Buffer subpass = org.lwjgl.vulkan.VkSubpassDescription.calloc(1,
                    stack);
            ...
            org.lwjgl.vulkan.VkSubpassDependency.Buffer dependency = org.lwjgl.vulkan.VkSubpassDependency.calloc(1,
                    stack);
            dependency.srcSubpass(org.lwjgl.vulkan.VK10.VK_SUBPASS_EXTERNAL);
            dependency.dstSubpass(0);
            dependency.srcStageMask(org.lwjgl.vulkan.VK10.VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT
                    | org.lwjgl.vulkan.VK10.VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT);
            dependency.srcAccessMask(0);
            dependency.dstStageMask(org.lwjgl.vulkan.VK10.VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT
                    | org.lwjgl.vulkan.VK10.VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT);
            dependency.dstAccessMask(org.lwjgl.vulkan.VK10.VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT
                    | org.lwjgl.vulkan.VK10.VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT);

            org.lwjgl.vulkan.VkRenderPassCreateInfo renderPassInfo = org.lwjgl.vulkan.VkRenderPassCreateInfo
                    .calloc(stack);
            ...
            if (org.lwjgl.vulkan.VK10.vkCreateRenderPass(context.getDevice(), renderPassInfo, null,
                    pRenderPass) != org.lwjgl.vulkan.VK10.VK_SUCCESS) {
